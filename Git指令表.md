...
1. #### 将远程指定分支拉取到本地指定分支上
   ...
   ```Git
   git pull <远程仓库名称> <远程指定分支>:<本地指定分支>
   ```

2. #### 将远程分支指定分支拉取到当前本地分支上

   ```Git
   git pull <远程仓库名称> <远程指定分支>
   ```

3. #### 将与本地分支同名的远程分支（需绑定好的）拉取到本地分支上
...
1. 将指定的本地分支推送到指定的远程分支上

   ```Git
   git push <远程仓库名称> <本地指定分支>:<远程指定分支>
   ```

2. 将指定本地分支推送到与该本地分支同名的远程分支上

   ```Git
   git push <远程仓库名称> <本地指定分支>
   ```

3. 将本地当前分支推送到对应的远程分支（同名的）
